<script>
    ...
    const months = [
        //this is literally cave man shit, why does JS date API not have this feature??
        "January",
        "Febuary",
        "March",
        "April",
...
<div class="min-h-[500px] border-1 mt-2 bg-gray-200 flex w-full">
    <div class="w-1/2 m-4">
        <div class="w-full flex">
            <h3 class="font-cantata text-3xl">
                {issue.title.en}, {formattedDate}
            </h3>
            <button
                class="max-w-8 ml-auto hover:bg-gray-400 rounded-lg aspect-square"
                onclick={download}
                ><img
                    src={downloadIcon}
                    alt="Download"
    ...
    <div class="ml-auto max-w-1/2 flex justify-center m-4">
