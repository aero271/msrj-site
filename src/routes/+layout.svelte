...
<header class="w-screen h-20 sticky top-0 z-10 bg-white flex flex-col items-center font-roboto-serif">
	<div class="flex h-[95%] w-2/3 items-center">
		<a href="/" class="h-full">
...
{@render children?.()}
<footer class="h-[32vh] w-screen mt-20 bg-gray-100 flex flex-col items-center font-roboto-serif justify-center">
	...
	<div class="w-2/3 h-full mt-2 flex justify-center">
		<div class="w-2/5 ">
			...
			<p class="italic text-sm my-2">A research journal for the rest of us.</p>
