...
<main class="flex flex-col items-center font-roboto-serif mx-2">
    <div class="w-full max-w-[1300px] mt-4">
        <h1 class="text-6xl font-cantata mt-4">Our Editorial Board</h1>

        <h1 class="mt-4 text-2xl">Leadership Team</h1>
        <div class="w-full h-[1px] bg-black mb-8 mt-3"></div>
        <div class="flex min-h-[350px]">
            <div class="min-w-2/3">
                ...
                <p class="indent-8">
                    "As the founder of the journal, I wanted to create a space
                    on campus for open intellectual inquiry to be shared with
                    the world."
                </p>
                ...
                <p class="indent-8">
                    "It provides students who submit with the opportunity to
                    receive high-quality feedback and support, along with
                ...
                <p class="indent-8">
                    "The community of intellectual and driven students on campus
                    working together to strengthen and support their fellow
                    students’ work."
                </p>
            </div>
            <div class="max-h-full w-full justify-center ml-auto max-w-[20%]">
                <img class="w-full" alt="Imre Huss" src={imrePhoto} />
            </div>
        </div>
        <div class="w-full h-[1px] bg-black my-8"></div>
        <div class="flex min-h-[300px]">
            <div class="min-w-2/3">
                <h2 class="text-4xl font-cantata">
                    Ms. Ailey Picasso - Faculty Editor - Founder
                </h2>
                <p class="text-lg italic mt-2">Why did you join MSRJ?</p>
                <p class="indent-8">
                ...
                <p class="indent-8">
                    "I love the complex and deep dialogue students often engage
                    in at our meetings."
                </p>
            </div>
            <div class="max-h-full w-full justify-center ml-auto max-w-[20%]">
                <img class="w-full" alt="Ailey Picasso" src={picassoPhoto} />
            </div>
        </div>
        <div class="w-full h-[1px] bg-black my-8"></div>

        <h1 class="mt-4 text-2xl">Section Editors</h1>
        <div class="w-full h-[1px] bg-black mb-4 mt-3"></div>
        <div class="flex items-center">
            <h2 class="text-4xl font-cantata flex items-center">
                Zev Balanson<span class="text-2xl mr-2 ml-10 font-roboto-serif"
                    >Head Editor, Social Sciences Sections</span
                >
            </h2>
            <img alt="Zev Balanson" src={zevPhoto} class="ml-auto" />
        </div>
        <div class="w-full h-[1px] bg-black my-4"></div>
        <div class="flex items-center">
            <h2 class="text-4xl font-cantata flex items-center">
                Amogh Tripathi<span class="text-2xl ml-10 font-roboto-serif">
                    Head Editor, Natural and Physical Sciences Sections</span
                >
            </h2>
            <img alt="Amogh Tripathi" src={amoghPhoto} class="ml-auto" />
        </div>
        <div class="w-full h-[1px] bg-black my-4"></div>
        <div class="flex items-center">
            <h2 class="text-4xl font-cantata flex items-center">
                Robert Ferro
                <span class="text-2xl ml-10 max-w-[70%] mr-2 font-roboto-serif"
                    >Head Editor, Humanities and Culture Section + Asst. Editor
                    for Formatting and Publication + Heir Apparent</span
                >
            </h2>
            <img alt="Robert Ferro" src={robertPhoto} class="ml-auto" />
        </div>
        <div class="w-full h-[1px] bg-black my-4"></div>
        <div class="flex items-center">
            <h2 class="text-4xl font-cantata flex items-center">
        ...
        <h1 class="mt-10 text-2xl">Faculty Reviewers</h1>
        <div class="w-full h-[1px] bg-black mb-4 mt-3"></div>
